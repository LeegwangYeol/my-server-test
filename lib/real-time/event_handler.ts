type EventHandlerCallbackType = (event: { [key: string]: any }) => void;
...
export class RealtimeEventHandler {
  eventHandlers: { [eventName: string]: EventHandlerCallbackType[] };
  nextEventHandlers: { [eventName: string]: EventHandlerCallbackType[] };
