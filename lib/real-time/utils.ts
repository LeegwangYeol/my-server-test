...
export class RealtimeUtils {
   ...
   * @returns {ArrayBuffer}
   */
  static base64ToArrayBuffer(base64: string): ArrayBuffer | ArrayBufferLike {
   ...
   * @returns {string}
   */
  static arrayBufferToBase64(arrayBuffer: ArrayBuffer | Int16Array | Float32Array | ArrayBufferLike): string {
